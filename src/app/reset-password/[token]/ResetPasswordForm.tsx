...
export default function ResetPasswordForm({ token, userName, userEmail }: Props) {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      const res = await resetPasswordAction(token, fd)
      ...
      <div className="login-center">
        ...
        <div className="login-card" style={{ animationDelay: '210ms' }}>
          ...
          <p className="login-subheading">
            Choose a strong password. You&apos;ll be signed in after this step.
          </p>
